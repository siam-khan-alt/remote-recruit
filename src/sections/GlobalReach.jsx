...
export default function GlobalReach() {
  return (
    <section className="w-full bg-[#FFFFFF] my-16 md:mt-[83px] pt-0 md:pt-2 md:mb-[170px] flex items-center justify-center ">
      <div className="w-full max-w-[1067px] min-h-auto md:h-[454px] mx-auto px-6 md:px-10 flex md:flex-row flex-col md:gap-10 lg:gap-[183px] items-center relative">
        {/* left */}
        <SectionHeader
        ...
        <div className=" relative w-full max-w-[355px] md:w-[355px] h-[451px] md:h-full p-5 rounded-[34px] bg-white flex flex-col items-start shadow-[14px_41px_100px_0px_rgba(49,89,211,0.12)] ">
          ...
          {/* Dashboard Mockup */}
          <div className="h-auto max-h-44 max-w-[315px] md:w-[315px] rounded-2xl shadow-[0_20px_50px_rgba(13,27,62,0.08)] overflow-hidden border border-[#F1F5F9]">
            <img
              src={DashboardMockup}
          ...
          <UserCard
            ...
            delay={0.2}
            className="right-0 md:right-[67px] top-[50%] md:top-58"
          />
          ...
          <UserCard
            ...
            delay={0.4}
            className="left-0 md:left-[19px] bottom-[37px] md:bottom-10"
          />
