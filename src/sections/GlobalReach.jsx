...
export default function GlobalReach() {
  return (
    <section className="w-full bg-[#FFFFFF] my-16 md:mt-20.75 pt-0 md:pt-2 md:mb-42.5 flex items-center justify-center overflow-hidden">
      <div className="w-full max-w-266.75 min-h-auto md:h-113.5 mx-auto px-6 md:px-10 flex md:flex-row flex-col md:gap-10 lg:gap-29 items-center relative">
        ...
        >
          {/* Floating Dot */}
          <div className="absolute top-6 md:-top-0.75 right-7 md:-left-4 w-5.5 h-5.5 z-10 animate-pulse">
            <img
              src={FloatingDot}
              alt="Decorative Dot"
          ...
          {/* Dashboard Mockup */}
          <div className="h-auto max-h-44 w-78.75 rounded-2xl shadow-[0_20px_50px_rgba(13,27,62,0.08)] overflow-hidden border border-[#F1F5F9]">
            <img
              src={DashboardMockup}
          ...
          <UserCard
            ...
            delay={0.2}
            className="md:right-16.75 top-[50%] md:top-58"
          />
          ...
          <UserCard
            ...
            delay={0.4}
            className="md:left-4.75 bottom-9.25 md:bottom-10"
          />
          ...
          <motion.div
            ...
            className="absolute right-6 md:-right-12.25 top-[45%] md:top-37.5 w-20 h-20 md:w-22.75 md:h-22.75 z-30 drop-shadow-lg"
          >
            <img
